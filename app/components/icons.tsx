...
export function GraduationIcon({ size = 20 }: { size?: number }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
...
export function ProjectIcon({ iconKey, color }: { iconKey: string; color: string }) {
  const props = { width: 20, height: 20, viewBox: "0 0 24 24" as const, fill: "none" as const, stroke: color, strokeWidth: 1.8, strokeLinecap: "round" as const, strokeLinejoin: "round" as const };
  switch (iconKey) {
    case "shield":
      return (
        <svg {...props}>
